...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='student',
            name='student_group',
            field=models.ForeignKey(verbose_name='Група', null=True, on_delete=django.db.models.deletion.SET_NULL, to='students.Group'),
        ),
        migrations.AddField(
            model_name='monthjournal',
            name='student',
            field=models.ForeignKey(verbose_name='Студент', to='students.Student', unique_for_month='date'),
        ),
    ]
